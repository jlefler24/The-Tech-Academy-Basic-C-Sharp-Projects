...
namespace CarInsurance.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            if (string.IsNullOrEmpty(firstName) || string.IsNullOrEmpty(lastName) || string.IsNullOrEmpty(emailAddress) || string.IsNullOrEmpty(carModel) || string.IsNullOrEmpty(coverageType)) // If they don't enter a string, it redirects to the error page.
            {
            ...
            else
            {
                ...
                if (thyDate - dateOfBirth.Year > 25) // Checks if their age is greater than 25.If it is,  It then adds $25 to the total.
                {
                    total = 50 + 25;
                }
                else if (thyDate - dateOfBirth.Year > 18 && thyDate - dateOfBirth.Year < 25) // Checks if their age is greater than 18 AND less than 25. If it is, It then adds $50 to the total.
                {
                    total = 50 + 50;
                }
                else if (thyDate - dateOfBirth.Year <= 18) // Checks if their age is less than 18. If it is, It adds $100 to the total.
                {
                    total = 50 + 100;
                };
                if (carYear <= 2000 || carYear >= 2015) // Checks if their Year is less than 2000 or more than 2015. If either is true, it adds $25 to the total.
                {
                    total += 25;
